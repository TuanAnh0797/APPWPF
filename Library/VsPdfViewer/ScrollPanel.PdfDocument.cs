    ...
    public partial class ScrollPanel
    {
        ...
        public void GotoPage(int page)
        {
            if (IsDocumentLoaded)
            {
                ...
                if (PagesDisplayMode == PdfiumViewerPagesDisplayMode.BookMode && page + 1 < Document.PageCount)
                {
        ...
        public void NextPage()
        {
            if (IsDocumentLoaded)
            {
                var extentVal = PagesDisplayMode == PdfiumViewerPagesDisplayMode.BookMode ? 2 : 1;
