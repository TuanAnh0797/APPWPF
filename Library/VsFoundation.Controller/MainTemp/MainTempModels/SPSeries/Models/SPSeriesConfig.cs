...
namespace VsFoundation.Controller.MainTemp.MainTempModels.SPSeries.Models;

public class SPSeriesConfig : IConfigurationMainTemperatureController
{
    public eMainTempMode Mode { get; set; }
    public short PatternID { get; set; } = 1;
